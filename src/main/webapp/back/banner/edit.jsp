...
<script>
    $(function(){
        $("#editForm").form('load','${pageContext.request.contextPath}/banner/findOne?id=${param.id}');
    });
</script>
<div style="text-align: center;">
    <form id="editForm" class="easyui-form" method="post" enctype="multipart/form-data">
