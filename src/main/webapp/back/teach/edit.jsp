...
<script>
    $(function(){
        $("#editTeach").form('load','${pageContext.request.contextPath}/teach/findOne?id=${param.id}');
    });
</script>
<div style="text-align: center;">
    <form id="editTeach" class="easyui-form" method="post" enctype="multipart/form-data">
