...
<script>
        $("#teach").datagrid({
            url:'${pageContext.request.contextPath}/teach/findAll',
            ...
            columns:[[
                ...
                {field:'head_img',title:'图片地址',width:180,},
                {field:'sex',title:'性别',width:150,},
                {title:"options",field:"options",width:250,
        ...
        function delRow(id) {
            ...
            $.messager.confirm("操作提示", "您确定要删除该记录吗？", function (r) {
                if (r) {
                    ...
                    $.post("${pageContext.request.contextPath}/teach/delete",
                        {"id":id},
        ...
        function upd(id) {
            $("#teachedit").dialog({
                href:"${pageContext.request.contextPath}/back/teach/edit.jsp?id="+id,
                buttons:[
                    {
                        text:"保存",
                        iconCls:"icon-save",
                        handler:function(){
                            $("#editTeach").form('submit',{
                ...
                buttons:[
                    {
                        ...
                        iconCls:"icon-save",
                        handler:function(){
                            $("#addTeach").form('submit',{
                                url:"${pageContext.request.contextPath}/teach/add",
...
<table id="teach" data-options="fit:true">
...
<%--创建添加的弹出窗口--%>
<div id="teachadd"
     data-options=" href:'${pageContext.request.contextPath}/back/teach/add.jsp',
                            width:600,
                            height:450,
...
<%--创建修改窗口的div--%>
<div id="teachedit" data-options="draggable:false,width:650,height:500,iconCls:'icon-edit',title:'修改用户信息'"></div>
